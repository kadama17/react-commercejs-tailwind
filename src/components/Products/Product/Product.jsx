                            ...
                            <div className="flex-auto justify-evenly">
                                <div className="flex flex-wrap ">
                                    ...
                                    <div className="flex items-center w-full justify-between min-w-0 ">
                                        <h2 className="text-lg mr-auto cursor-pointer text-gray-200 hover:text-purple-500 truncate ">{product.name}
                                        </h2>
                                        <div className="flex items-center bg-green-400 text-white text-xs px-2 py-1 ml-3 rounded-lg">
                                            INSTOCK</div>
                                    </div>
                                </div>
                                <div className="text-xl text-white font-semibold mt-1">{product.price.formatted}</div>
                                <div className="lg:flex  py-4  text-sm text-gray-600">
                                    ...
                                    <div className="flex-1 inline-flex items-center mb-3">
                                        <Typography style={{ color: "white", fontWeight: "bolder" }} dangerouslySetInnerHTML={{ __html: product.description }} variant="body2" component="p" />
